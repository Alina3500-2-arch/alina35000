...
const PACKAGES = [
  ...
  { id: 'o', name: 'Оптимум',  price: '38 000 ₽', month: '12 000 ₽/мес',
    monthNote: 'ведение рекламы — как сейчас', prepay: '19 000 ₽', term: '10 рабочих дней',
  ...
  { id: 'k', name: 'Комплекс', price: '48 000 ₽', month: '12 000 ₽/мес',
    monthNote: 'ведение рекламы — как сейчас', prepay: '24 000 ₽', term: '15 рабочих дней',
...
<section>
  ...
  <div class="callout">
    <p><b>Перенастройка рекламы под новый сайт входит в стоимость сайта.</b> Новые объявления под новые
    страницы, новые цели, перезапуск кампаний. Если бы сайт делал кто-то со стороны, эту работу
    пришлось бы оплачивать отдельно.</p>
    <p><b>Ежемесячно — 12 000 ₽, как сейчас.</b> Это ведение рекламы: кампании на поиске и в РСЯ,
    корректировка ставок, минус-слова, контроль стоимости записи. Сумма не меняется ни в одном
    из вариантов и не растёт после запуска сайта.</p>
  </div>
</section>
...
<section>
  ...
  <div class="callout">
    ...
    <p>Ведение рекламы — <b>3–4 визита в месяц</b>, и это то, что вы платите уже сейчас.</p>
...
<section>
  ...
  <p>Абонентской платы за сайт нет. Первые <b>14 дней после сдачи правим бесплатно</b> — это время,
  чтобы всё вычитать и досогласовать. Дальше — только когда что-то реально нужно поменять, по этому прайсу.
  Чтобы вы заранее знали цифры и не гадали.</p>
  <table>
  ...
  до трёх рабочих дней. Опечатку или неверный телефон исправляем бесплатно и сразу, это не «правка».</p>
</section>
