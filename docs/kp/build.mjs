...
<section>
  ...
  <div class="facts">
    ...
    <div class="fact"><b>3 500 ₽</b><span>средний чек за визит</span></div>
  </div>
...
<section>
  ...
  <div class="callout">
    <p><b>Перенастройка рекламы под новый сайт входит в стоимость сайта.</b> Новые объявления
    под новые страницы, новые цели, перезапуск кампаний. Если бы сайт делал кто-то со стороны,
    эту работу пришлось бы оплачивать отдельно.</p>
